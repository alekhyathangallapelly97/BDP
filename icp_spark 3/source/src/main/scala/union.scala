...
object union{
  def main(args: Array[String]): Unit = {
    ...
    val df = spark.read
      ...
      .load("C:/Users/alekh/OneDrive/Desktop/survey.csv")
    //Save data to the ouput folder
    df.write.format("csv").option("header","true").save("C:/Users/alekh/OneDrive/Desktop/output")
    ...
    val lines = sc.textFile("C:/Users/anees/Downloads/survey.csv")
